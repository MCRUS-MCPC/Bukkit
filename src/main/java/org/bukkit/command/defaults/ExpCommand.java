...
public class ExpCommand extends VanillaCommand {
    public ExpCommand() {
        super("xp");
        this.description = "Выдает указанному игроку указаное количество опыта. Указывайте <количество>L для выдачи уровней. Если значение отрицательное, то опыт снимается.";
