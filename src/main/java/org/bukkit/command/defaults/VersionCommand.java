...
public class VersionCommand extends BukkitCommand {
    ...
    public boolean execute(CommandSender sender, String currentAlias, String[] args) {
        ...
        if (args.length == 0) {
            sender.sendMessage("Данный сервер работает на основе " + Bukkit.getName() + " версии " + Bukkit.getVersion() + " (Реализация API версии " + Bukkit.getBukkitVersion() + "). Перевод Alex_Bond_UA.");
        } else {
